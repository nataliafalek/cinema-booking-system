        ...
        scheduledMovies.forEach(sm ->
                {
                    ...
                    for (Seat seat : seats) {
                        seatReservationByScheduledMovies.add(new SeatReservationByScheduledMovie(sm.getScheduledMovieId(), sm.getCinemaHallId(), true, 10, seat.getSeatId(), seat.getSeatNumber(), seat.getRowNumber()));
                    }
